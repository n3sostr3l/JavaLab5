 ...
 * Сравнение выполняется по полю maximumPoint через метод {@link com.akira.general.datas.LabWork#compareTo}.
 * </p>
 */
public class ReplaceGreatestCommand implements Modable {
